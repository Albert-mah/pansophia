...
- `body` 2-4 个**小点**、合计 200-500 字,每个小点 `{t:"小标题", p:"段落"}`:
  ...
  小标题 4-12 字、名词短语(如「三类认知负荷」「识别优于回忆」)。
  **框架铁律(2026-07-11,用户定):第一个小点必须回答「为什么需要它——不会它你想说/想做的哪件事做不到」**
  (给一个具体的受挫场景,不是抽象概念),中间小点讲规则/是什么,**最后一个小点回答
  「学会它通往哪里」**(下游能解锁什么,点名后续考点)。光甩规则分组、没有原因和用途的卡
  =不合格。口吻按学段(小学活泼、初中直白、高中严谨)。
